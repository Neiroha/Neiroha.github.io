...
| Base URL | `eastus`，或 `https://eastus.tts.speech.microsoft.com` |
| API Key | Azure Speech subscription key |
| Default Model | 留空 |

Neiroha 接受三种 Base URL：
...
| Fetch All 为空 | Base URL 不是 Speech TTS endpoint | 直接填区域名，例如 `eastus` |
